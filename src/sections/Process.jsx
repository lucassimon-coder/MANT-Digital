...
export default function Process() {
  ...
  return (
    <section 
      id="proceso" 
      ref={sectionRef}
      className="py-20 md:py-32 bg-zinc-50 relative overflow-hidden border-t border-zinc-100"
    >
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="flex flex-col">
            {/* Section Header */}
            <div 
              className={`space-y-4 mb-12 md:mb-16 transition-all duration-700 ease-out transform ${
            ...
            {/* Timeline Steps List */}
            <ol className="relative border-l-2 border-zinc-200/80 ml-4 pl-8 md:ml-6 md:pl-10 space-y-12 list-none p-0 m-0">
              {steps.map((step, index) => (
                ...
                >
                  ...
                  <span className="absolute -left-[41px] md:-left-[49px] top-1.5 flex h-6 w-6 items-center justify-center rounded-full bg-white ring-4 ring-zinc-50 border-2 border-zinc-300 group-hover:border-zinc-900 transition-colors duration-300">
